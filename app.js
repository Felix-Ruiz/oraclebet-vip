...
// 🚀 LA CARGA DE BASE DE DATOS SE HACE SIEMPRE AL INICIO
...
// 🚀 EL CORREO DEL ADMIN SE LIMPIA CON .trim() AL INGRESARLO
    ...
    if (codigoIngresado.startsWith("MASTER_")) {
        try {
            if (!correoAdminTemp) {
                ...
                correoAdminTemp = pmt.trim(); // 🚀 FIX: Esto elimina el espacio en blanco al final del correo
            }
...
// ==========================================
// 15. ADMIN: GESTIÓN DE FONDOS DE INVERSIÓN
// ==========================================
